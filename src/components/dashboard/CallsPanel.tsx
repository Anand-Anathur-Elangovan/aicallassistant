...
export function CallFiltersBar({
  ...
  return (
    <div className="flex flex-wrap gap-2 items-end p-3 bg-gray-50 dark:bg-gray-800/50 rounded-xl border dark:border-gray-700">
      <div className="flex-1 min-w-[160px]">
        ...
        <input
          ...
          className="w-full px-3 py-1.5 text-sm border rounded-lg dark:bg-gray-900 dark:border-gray-600"
        />
      </div>
      <div>
        ...
        <input
          ...
          className="px-2 py-1.5 text-sm border rounded-lg dark:bg-gray-900 dark:border-gray-600"
        />
      </div>
      <div>
            ...
            <tbody>
              {shown.map((c) => {
                ...
                return (
                  ...
                  >
                    <td className="p-3">
                      <div className="font-medium">{c.caller_number || "Unknown"}</div>
                      <div className="text-xs text-gray-400">{fmtDuration(c.duration_seconds)}</div>
                    </td>
                    ...
                    <td className="p-3 text-gray-500 hidden lg:table-cell max-w-xs truncate">
